...
#Participating
The first step to participating in the humans project is to begin creating your human object. For now, just model it after johnDoe.json. Since names aren’t unique identifiers, though, using “firstLast.json” or “firstMiddleLast.json” as the filename should suffice temporarily. Using a UID system for higher specificity is in construction, so head over to [the naming issue](https://github.com/kevincoleman/humans/issues/1) to voice your input.
